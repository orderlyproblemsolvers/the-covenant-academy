<template>
    <section class="bg-gray-50 py-16 font-inter">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <span class="block">Testimonies from our TCA Family</span>
      </h1>
        ...
        <div class="flex gap-6 overflow-x-auto pb-4 hide-scrollbar">
          <div
            ...
            :key="index"
            class="bg-white border border-gray-200 shadow p-6 min-w-[300px] max-w-[350px] flex-shrink-0 flex flex-col justify-between"
          >
            <div>
            ...
            <button
              ...
              class="mt-4 text-indigo-600 hover:underline font-medium self-start"
            >
              Read More
            </button>
          </div>
      ...
      >
        <div class="bg-white border border-gray-200 shadow-lg max-w-2xl w-full p-6 relative">
          <button
            @click="closeModal"
